 ...
 * @author Pichau
 */
public class TelaHoteis extends javax.swing.JPanel implements MouseListener{
    ...
    public void escolherFundo() {
        if(h.getCaminhoImagem() == null) {
            ...
            switch (estado) {
                ...
                this.fundo = new ImageIcon(h.getCaminhoImagem()).getImage();
        }
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g.fillRect(getWidth() -175, 0, 175, getHeight());
